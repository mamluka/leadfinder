angular.module('leadFinder', ['leadFinder.values.services', 'leadFinder.general.services', 'leadFinder.general.directives', 'leadFinder.wizard.directives', 'leadFinder.order-form.directives', 'leadFinder.analytics.directives', 'leadFinder.geo.controllers', 'leadFinder.wizard.controllers', 'leadFinder.summery.controller', 'leadFinder.order-form.controllers', '$strap.directives'],function ($routeProvider, $locationProvider) {
